...
const MusicPlayer = () => {
  ...
  //  Make sure you have your songs, images and artist in the public folder named like below
    const songs = useMemo(() =>[
      ...
      // { title: 'Hayyoda', src: '/hayyoda.mp3', image: '/hayyoda.jfif', artist: 'Anirudh Ravichandar' },
          ...
          <div className="playpausenextback">
            <div className="controls">
              <div className='fav'>
                ...
                {isFavorite ? <i className="ifav"><span className='tooltip'>Remove from Favourite</span><MdOutlineFavorite/></i> : 
                <i className='ifav'><span className='tooltip'>Add to Favourite</span><MdOutlineFavoriteBorder/></i>}
                </button>
              </div>
